  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        setProduct(response.data.product); // Update state with the product data
      } catch (error) {
                ...
                <div className="lg:order-2 lg:ml-5">
                  <div className="max-w-xl overflow-hidden rounded-lg">
                    <img
                      ...
                      src={product.images[0].url} // Use product image URL from API
                      alt={product.name} // Alt text should be dynamic based on product name
                    />
                  </div>
                </div>
              </div>
